-- WebChat Operation Platform - Database Schema
-- Phase 1

CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Users table (local auth for Phase 1; AD integration in Phase 2)
...
CREATE TABLE IF NOT EXISTS agent_servers (
    ...
    api_key     TEXT,                        -- pre-shared key (Phase 1); mTLS in Phase 2
    os_type     VARCHAR(20) DEFAULT 'linux', -- linux | windows
    shell_type  VARCHAR(20) DEFAULT 'bash',  -- bash | powershell | cmd
    is_active   BOOLEAN DEFAULT TRUE,
...
CREATE TABLE IF NOT EXISTS chat_messages (
    ...
    -- When a message carries a parsed command payload
